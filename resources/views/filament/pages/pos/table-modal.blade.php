                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full min-w-[650px]">
                                        ...
                                        <tbody class="divide-y divide-slate-100 bg-white">
                                            ...
                                            @empty
                                                <tr><td colspan="6" class="px-6 py-12 text-center text-sm text-slate-500">Đơn hàng chưa có món. Chọn “Thêm món” để bắt đầu.</td></tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                </div>
